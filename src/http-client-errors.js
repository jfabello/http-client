...
/**
 * Thrown when HTTP response headers are not an object.
 * @class ERROR_HTTP_RESPONSE_HEADERS_TYPE_INVALID
 * @extends TypeError
 */
...
/**
 * Thrown when HTTP response status code is not an integer.
 * @class ERROR_HTTP_RESPONSE_STATUS_CODE_TYPE_INVALID
 * @extends TypeError
 */
...
/**
 * Thrown when HTTP response status code is not between 100 and 599.
 * @class ERROR_HTTP_RESPONSE_STATUS_CODE_OUT_OF_BOUNDS
 * @extends RangeError
 */
...
/**
 * Thrown when HTTP response status message is not a string.
 * @class ERROR_HTTP_RESPONSE_STATUS_MESSAGE_TYPE_INVALID
 * @extends TypeError
 */
...
/**
 * Thrown when HTTP response body is not an object.
 * @class ERROR_HTTP_RESPONSE_BODY_TYPE_INVALID
 * @extends TypeError
 */
